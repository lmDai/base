package com.common.refreshlibrary.view;
...
import com.common.refreshlibrary.R;
...
public class RefreshProgressWheel extends View {
  ...
  private void parseAttributes(TypedArray a) {
    ...
    circleRadius =
        (int) a.getDimension(R.styleable.RefreshProgressWheel_matProg_circleRadius, circleRadius);

    fillRadius = a.getBoolean(R.styleable.RefreshProgressWheel_matProg_fillRadius, false);

    barWidth = (int) a.getDimension(R.styleable.RefreshProgressWheel_matProg_barWidth, barWidth);

    rimWidth = (int) a.getDimension(R.styleable.RefreshProgressWheel_matProg_rimWidth, rimWidth);

    float baseSpinSpeed =
        a.getFloat(R.styleable.RefreshProgressWheel_matProg_spinSpeed, spinSpeed / 360.0f);
    spinSpeed = baseSpinSpeed * 360;

    barSpinCycleTime =
        a.getInt(R.styleable.RefreshProgressWheel_matProg_barSpinCycleTime, (int) barSpinCycleTime);

    barColor = a.getColor(R.styleable.RefreshProgressWheel_matProg_barColor, barColor);

    rimColor = a.getColor(R.styleable.RefreshProgressWheel_matProg_rimColor, rimColor);

    linearProgress = a.getBoolean(R.styleable.RefreshProgressWheel_matProg_linearProgress, false);

    if (a.getBoolean(R.styleable.RefreshProgressWheel_matProg_progressIndeterminate, false)) {
      spin();
    }
